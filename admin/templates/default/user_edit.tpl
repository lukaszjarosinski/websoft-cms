...
{assign var=user value=$auth_class->showUser($smarty.request.id)}
{/if}
</div>
...
<p><label for="url">{$lang.url_address}</label> <input type="text" name="url" class="text-input large-input" id="url" value="{$user.url}" /></p>
