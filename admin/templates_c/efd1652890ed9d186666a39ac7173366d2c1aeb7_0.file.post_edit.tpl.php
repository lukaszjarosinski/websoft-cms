...
/* Smarty version 4.0.0, created on 2021-12-01 13:20:47
  from '/home/lukaszjaro/public_html/demo/cms/admin/templates/default/post_edit.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.0.0',
  'unifunc' => 'content_61a7689f05fec1_96977774',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'efd1652890ed9d186666a39ac7173366d2c1aeb7' => 
    array (
      0 => '/home/lukaszjaro/public_html/demo/cms/admin/templates/default/post_edit.tpl',
      1 => 1637670067,
      2 => 'file',
    ),
  ),
  ...
  array (
    ...
    'file:header.tpl' => 1,
    'file:menu.tpl' => 1,
    'file:category_list_submenu_post.tpl' => 1,
    'file:page_list_submenu_langs.tpl' => 1,
    'file:footer.tpl' => 1,
    'file:html_footer.tpl' => 1,
  ),
),false)) {
function content_61a7689f05fec1_96977774 (Smarty_Internal_Template $_smarty_tpl) {
...
<h3><?php echo $_smarty_tpl->tpl_vars['lang']->value['post_edit'];?>
</h3>
...
<textarea name="text1" id="text1" rows="7" cols="30" class="text-input textarea"><?php echo $_smarty_tpl->tpl_vars['post']->value['text'];?>
</textarea></p>
...
<p><label for="category"><?php echo $_smarty_tpl->tpl_vars['lang']->value['category'];?>
 <?php echo $_smarty_tpl->tpl_vars['lang']->value['select_multiple'];?>
</label> <select name="category[]" id="category" multiple="multiple" size="10" class="medium-input">
<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['posts']->value->categoryList('published'), 'a');
$_smarty_tpl->tpl_vars['a']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['a']->value) {
$_smarty_tpl->tpl_vars['a']->do_else = false;
?>
<option value="<?php echo $_smarty_tpl->tpl_vars['a']->value['id'];?>
"<?php if ($_REQUEST['action'] == 'edit' && $_smarty_tpl->tpl_vars['post']->value['categories'] != '' && in_array($_smarty_tpl->tpl_vars['a']->value['id'],$_smarty_tpl->tpl_vars['post']->value['categories'])) {?> selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['a']->value['title'];?>
</option>
<?php if ($_smarty_tpl->tpl_vars['a']->value['submenu']) {
$_smarty_tpl->_assignInScope('level', $_smarty_tpl->tpl_vars['level']->value+1);
$_smarty_tpl->_subTemplateRender("file:category_list_submenu_post.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('a'=>$_smarty_tpl->tpl_vars['a']->value['submenu'],'level'=>$_smarty_tpl->tpl_vars['level']->value), 0, true);
}
}
...
</label> <input type="text" class="text-input large-input" name="order" id="order" value="<?php echo $_smarty_tpl->tpl_vars['post']->value['order'];?>
" /></p>
<p><label for="post_on"><?php echo $_smarty_tpl->tpl_vars['lang']->value['post_on'];?>
 ...
 <input type="radio" name="post_on" id="post_on2" value="0"<?php if ($_smarty_tpl->tpl_vars['post']->value['post_on'] == '0') {?> checked="checked"<?php }?> /> <?php echo $_smarty_tpl->tpl_vars['lang']->value['no'];?>
 </p>
...
--</option>
<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['posts']->value->postsList('',false), 'pages_list');
...
wartosc = ($.ajax({
url: "<?php echo $_smarty_tpl->tpl_vars['domain']->value;?>
admin/post.php?action=slugExists",
async: false,
data: 'slug='+value+'&id=<?php echo $_smarty_tpl->tpl_vars['post']->value['id'];?>
'
}));
...
formSubmit('post_add','<?php echo $_smarty_tpl->tpl_vars['domain']->value;?>
admin/post.php','<?php echo $_smarty_tpl->tpl_vars['domain']->value;?>
admin/post.php');
},
rules: {
title: {
